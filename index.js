...
function analyzePlanet(planet, allPlanets, allAspects) {
    ...
    const decanateRuler = DECANATE_RULERS[sign.toUpperCase()][decanateIndex];
    ...
    const sabianSymbol = (SABIAN_SYMBOLS[sign.toUpperCase()] && SABIAN_SYMBOLS[sign.toUpperCase()][sabianDegree]) 
        ? SABIAN_SYMBOLS[sign.toUpperCase()][sabianDegree]
